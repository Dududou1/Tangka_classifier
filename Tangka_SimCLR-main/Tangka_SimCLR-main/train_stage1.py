...
def train(args):
    ...
    train_dataset = load_dataset.PreDataset(root='dataset', train=True, transform=config.train_transform, download=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max_epoch', default=10, type=int, help='')
